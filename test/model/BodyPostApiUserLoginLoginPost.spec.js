...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IVolApi.BodyPostApiUserLoginLoginPost();
  });
  ...
  describe('BodyPostApiUserLoginLoginPost', function() {
    it('should create an instance of BodyPostApiUserLoginLoginPost', function() {
      // uncomment below and update the code to test BodyPostApiUserLoginLoginPost
      //var instane = new IVolApi.BodyPostApiUserLoginLoginPost();
      //expect(instance).to.be.a(IVolApi.BodyPostApiUserLoginLoginPost);
    });
