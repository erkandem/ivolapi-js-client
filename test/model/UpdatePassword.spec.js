...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IVolApi.UpdatePassword();
  });
  ...
  describe('UpdatePassword', function() {
    it('should create an instance of UpdatePassword', function() {
      // uncomment below and update the code to test UpdatePassword
      //var instane = new IVolApi.UpdatePassword();
      //expect(instance).to.be.a(IVolApi.UpdatePassword);
    });
